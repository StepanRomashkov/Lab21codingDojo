...
CREATE TABLE `bootcamp` (
  `id` int(11) NOT NULL,
  `bcName` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `bootcamp` VALUES (1,'Java'),(2,'Front-end'),(3,'.NET (C#)'),(4,'Python'),(6,'499ddaad9df107bf7107a3e2c0064800');
...
-- Dump completed on 2016-09-09  2:55:48
